    ...
    return (
        ...
        <div className='flex-shrink-0  p-5 h-full w-[330px] rounded-xl bg-orange-500 '>
            <div className='flex justify-between items-center'>
                ...
                <h4 className='text-sm font-semibold'>2025-02-12</h4>
            </div>
            <h1 className='text-xl mt-5 font-semibold '>Develop Home Page</h1>
            <p className='mt-2 text-base'>Complete it after you free </p>
            <div className='mt-4'>
                <button className='bg-green-500 w-full rounded py-1 px-2 text-sm'>Completed </button>
            </div>
        </div>
